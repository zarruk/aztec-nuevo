...
const formatearFecha = (fechaISO?: string, tipo?: string) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      {/* Banner principal con fondo de gradiente */}
      <div className="relative bg-gradient-to-r from-purple-800 via-violet-900 to-purple-800 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Partículas decorativas */}
        <div className="absolute inset-0 overflow-hidden opacity-20">
          {/* Partículas decorativas aquí */}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
              Aprende habilidades prácticas con nuestros talleres especializados en desarrollo web, móvil y más.
            </p>
            
            {/* INDICADOR VISUAL DE ACTUALIZACIÓN */}
            <div className="mt-6 inline-block bg-green-500 text-white px-4 py-2 rounded-md animate-pulse">
              Versión actualizada - {new Date().toISOString().split('T')[0]}
            </div>
            
            <div className="mt-8 flex justify-center space-x-4 animate-fade-in-up animation-delay-400">
              <a href="#talleres" className="bg-white text-purple-800 hover:bg-purple-100 font-medium px-6 py-3 rounded-md transition duration-300 transform hover:scale-105">
                Ver Talleres
              </a>
              <a href="/contacto" className="bg-transparent text-white border-2 border-white hover:bg-white hover:text-purple-800 font-medium px-6 py-3 rounded-md transition duration-300 transform hover:scale-105">
                Contactar
              </a>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-[#fffdf9] relative">
        {/* Botón flotante de registro para móviles */}
        <div className="fixed bottom-6 right-6 z-50 md:hidden">
          <a 
            href="https://wa.me/573128511052?text=Hola,%20me%20interesa%20registrarme%20en%20un%20taller" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center bg-[#2a7c60] text-white p-4 rounded-full shadow-lg hover:bg-[#1b5e4f] transition-colors transform hover:scale-105 duration-300"
